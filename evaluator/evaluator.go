...
func evalPrefixExpression(operator string, prefix object.Object) object.Object {
	switch operator {
	case "!":
		return evalBangOperatorExpression(prefix)
	case "-":
		return evalMinusPrefixOperatorExpression(prefix)
	default:
		return newError("unknown operator: %s%s", operator, prefix.Type())
	}
}
...
func evalBangOperatorExpression(prefix object.Object) object.Object {
	switch prefix {
	case TRUE:
		return FALSE
	case FALSE:
...
func evalMinusPrefixOperatorExpression(prefix object.Object) object.Object {
	if prefix.Type() != object.IntegerObj {
		return newError("unknown operator: -%s", prefix.Type())
	}

	value := -prefix.(*object.Integer).Value
